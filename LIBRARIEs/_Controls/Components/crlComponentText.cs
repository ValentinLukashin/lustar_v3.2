...
{
    /// <summary>
	/// Класс 'crlComponentText'
    /// </summary>
    /// <remarks>Компонент для ввода текста</remarks>
    public class crlComponentText : RichTextBox
    {
        #region = БИБЛИОТЕКИ
        ...
        {
            CHARFORMAT cf = this.__fCharFormat_;
		...
		/// </summary>
		/// <remarks>This method should be called every time a call is made to BeginUpdate. It resets the event mask to it's original value and enables redrawing of the control.</remarks>
        ...
        public virtual int __fSymbolCount_
        {
        ...
        public PARAFORMAT __fParaFormat_
        {
            get
            {
        ...
        public PARAFORMAT __fDefaultParaFormat_
        {
            get
            {
                PARAFORMAT pf = new PARAFORMAT();
        ...
        public CHARFORMAT __fCharFormat_
        {
            get
            {
        ...
        public CHARFORMAT __fDefaultCharFormat_
        {
            get
            {
                CHARFORMAT cf = new CHARFORMAT();
			...
			try
			{
				...
				for (i = 0; i < k; i++)
				{
					...
					if (bHTML)
					{
						...
						cf = this.__fCharFormat_;
						pf = this.__fParaFormat_;
		...
		public void AddHTML(string strHTML)
		{
			...
			cf = this.__fDefaultCharFormat_; // to apply character formatting
			pf = this.__fDefaultParaFormat_; // to apply paragraph formatting
