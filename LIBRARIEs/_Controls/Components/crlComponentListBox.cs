...
{
    /// <summary>
    /// Класс 'crlComponentList'
    /// </summary>
    /// <remarks>Компонент для просмотра списка данных</remarks>
    public class crlComponentListBox : ListBox
    {
        #region = ДИЗАЙНЕРЫ
        ...
        public void __mDataRefresh()
        {
            ...
            ValueMember = "__pClue"; // столбец с идентификатором записи
            Refresh();
