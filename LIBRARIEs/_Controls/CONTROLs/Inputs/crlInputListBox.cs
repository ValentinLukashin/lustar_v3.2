...
{
    /// <summary>Класс 'crlInputListBox'
    /// </summary>
    /// <remarks>Поле ввода множественных значений</remarks>
    public class crlInputListBox : crlInput
    {
        #region = МЕТОДЫ
        ...
        /// <summary>Обновление отображаемых данных
        /// </summary>
        ...
        /// <summary>Добавление значения в конец списка значений компонента
        /// </summary>
        ...
        /// <summary>Изменение имени в уже отображаемом списке
        /// </summary>
        ...
        /// <summary>Добавление списка новых значений
        /// </summary>
        ...
        /// <summary>Очистка всех данных и подготовка к вводу новых данных
        /// </summary>
        public virtual void __mItemsClear()
        {
            _cInput.__mItemsClear();
        }
        /// <summary>Загрузка данных из сущности данных
        /// </summary>
        ...
        /// <summary>Загрузка данных из {DataTable}, со столбцами clu(идентификатор) и des(название)
        /// </summary>
        ...
        /// <summary>Получение индекса значения по идентификатору значения
        /// </summary>
        ...
        /// <summary>Возвращает идентификатор выбраной записи
        /// </summary>
        ...
        /// </summary>
        protected crlComponentListBox _cInput = new crlComponentListBox();
...
#pragma warning disable CS0109 // Член "crlInputListBox.__pValueS" не скрывает доступный член. Ключевое слово new не требуется.
        public new List<appUnitItem> __pValueS 
#pragma warning restore CS0109 // Член "crlInputListBox.__pValueS" не скрывает доступный член. Ключевое слово new не требуется.
        {
            get 
            {
